window.onload = function () {
  ...
  selectores.forEach(function (selector) {
    ...
    selector.parentElement.appendChild(contenedores[contenedores.length - 1]); // En el body añado el contenedor
