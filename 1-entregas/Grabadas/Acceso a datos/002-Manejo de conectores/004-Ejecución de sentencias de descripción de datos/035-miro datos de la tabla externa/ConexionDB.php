...
class conexionDB // Creo una nueva clase
{
			...
			foreach ($row as $clave => $valor) {
				...
				foreach ($restricciones as $restriccion) {
					...
					if ($clave == $restriccion["COLUMN_NAME"]) {
						// En el caso de que se detecte que esta columna forma parte de las restricciones
				...
				if ($pasas == true) {
					// en el caso de que la variable siga siendo verdadera
	...
	{
		// Método de inserción de nuevos registros
