    ...
    datos.forEach(function (registro) {
        ...
        Object.keys(registro).forEach((clave) => {
            ...
            nuevacolumna.ondblclick = function () {
                // Comportamiento de cuando hago doble click en la celda
                console.log("Has hecho click en una celda");
                this.setAttribute("contenteditable", "true");
                this.focus();
            };
            nuevacolumna.onblur = function () {
                // Comportamiento de cuando salgo de la celda
                ...
                fetch("../../servidor/?o=actualizar", {
                    // Ahora realizo una peticion al servidor y le paso el objeto
                    method: "POST",
                    headers: {
